import type { ActJWTClaim, experimental__CheckAuthorizationWithoutPermission, GetToken, MembershipRole, SignOut } from '@clerk/types';
type experimental__CheckAuthorizationSignedOut = (params?: Parameters<experimental__CheckAuthorizationWithoutPermission>[0]) => false;
type UseAuthReturn = {
    isLoaded: false;
